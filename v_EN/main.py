...
class CardioApp(ctk.CTk):
    def __init__(self):
        ...
        try:
            ...
            if os.path.exists(icon_p):
                ...
                print(f"Icon file not found: {icon_p}")
    ...
    def setup_ui(self):
        ...
        self.btn = ctk.CTkButton(self.bottom, text="Run Analysis", command=self.run_analysis,
    ...
    def setup_form(self):
        fields = [
            ("Age", 50, 0, "i"), ("Sex", ["Male", "Female"], 1, "c"),
            ("Systolic Blood Pressure", 120, 3, "i"), ("Resting Heart Rate", 70, "rest_hr", "i"),
            ("Maximum Heart Rate", 150, 7, "i"), ("Exercise-Induced Angina", 0, 8, "i"),
            ("Chest Pain Type (0-3)", 0, 2, "i"), ("Fasting Blood Sugar", 90, 5, "i"),
            ("Total Cholesterol", 200, 4, "i"), ("ECG Result", 0, 6, "i"),
            ("Major Vessels", 0, 11, "i"), ("ST Depression", 0.0, 9, "i"),
            ("ST Slope", 1, 10, "i"), ("Thal", 2, 12, "i")
        ]
